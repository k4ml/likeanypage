$(document).ready(function(){
    $('#generate').click(function(){
        var url = $('#url')[0].value;
        var like_url = 'http://www.facebook.com/plugins/like.php?href='+encodeURIComponent(url)+'&show_faces=true&width=55&action=like&colorscheme=light&layout=box_count';
